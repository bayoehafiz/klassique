...
$pages_confirmation = global_select_single("pages","*","id = 6");
?>
    </head>
                ...
                <div class="container heading-standar">
                    <div class="page-breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li><span>Payment Failed</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="shop">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 shop-done-wrap" style="text-align:center; font-size:1.38em;">
                                            <h1 class="f-8"><span class="f-red">Payment Error!</span></h1>
                                                ...
                                                <tbody>
                                                    <?php if($data_detail){foreach ($data_detail as $key => $value) {
                                                        ...
                                                        if(isset($value['custom_gambar']) AND $value['custom_gambar'] != ''){
                                                            $custom_gambar = '<img width="100" height="150" src="/web/uploads_custom_order/'.$value['custom_gambar'].'" width="60px"/>';
                                                        ...
                                                        <td class="product-name">
                                                            ...
                                                            <dl class="variation">
                                                                ...
                                                                if($data_detail){
                                                                    ...
                                                                    echo'<dt class="variation-CustomImage">Custom Image:</dt><dd class="variation-CustomImage"><p>'.$custom_gambar.'</p></dd>';
                                                                    }
                                                                } ?>
                                                            </dl>
                                                        </td>
