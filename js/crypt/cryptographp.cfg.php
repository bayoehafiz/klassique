...
$cryptwidth  = 80;  // Largeur du cryptogramme (en pixels)
$cryptheight = 29;   // Hauteur du cryptogramme (en pixels)
...
$charR = 116;     // Couleur des caractères au format RGB: Red (0->255)
$charG = 116;     // Couleur des caractères au format RGB: Green (0->255)
$charB = 127;     // Couleur des caractères au format RGB: Blue (0->255)
...
$tfont[] = 'tahoma.ttf';         // Ajoutez autant de lignes que vous voulez   
...
$charel = '1234567890';       // Caractères autorisés
...
$charspace = 14;        // Espace entre les caracteres (en pixels)
$charsizemin = 12;      // Taille minimum des caractères
$charsizemax = 12;      // Taille maximum des caractères
...
$cryptgrayscal = true;     // Transforme l'image finale en dégradé de gris (true/false)
                            // uniquement si PHP >= 5.0.0
