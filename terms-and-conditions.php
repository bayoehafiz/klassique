<?php 
include("header.php"); 
$help = global_select_single("help","*","id = 10");
?>
	</head>
				...
				<div class="container heading-standar">
					<div class="page-breadcrumb">
						<ul class="breadcrumb">
							...
							<li><span><?php echo $language_config[8]['lang_'.$curr_lang] ?></span></li>
						</ul>
					</div>
				</div>
			</div>
										...
										<div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <ul class="klassique-side-link f-g8">
                                                    ...
                                                    <li><a href="/<?php echo $curr_lang ?>/measurement-guide"><i class="fa fa-chevron-right" style="margin-right:5px;"></i><?php echo $language_config[67]['lang_'.$curr_lang] ?></a></li>
                                                    ...
                                                    <li><a href="/<?php echo $curr_lang ?>/terms-and-conditions" class="active"><i class="fa fa-chevron-right" style="margin-right:5px;"></i><?php echo $language_config[8]['lang_'.$curr_lang] ?></a></li>
                                                </ul>
                                            </div>
                                        </div>
									</div>
											...
											<div class="row inner">
												<div class="col-sm-12">
													<div class="content_element title">
														<h2><?php echo $language_config[8]['lang_'.$curr_lang] ?></h2>
													</div>
