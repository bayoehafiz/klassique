<?php 
include("header.php"); 
$help = global_select_single("help","*","id = 9");
?>
	</head>
				...
				<div class="container heading-standar">
					<div class="page-breadcrumb">
						<ul class="breadcrumb">
							...
							<li><span><?php echo $language_config[13]['lang_'.$curr_lang] ?></span></li>
						</ul>
					</div>
				</div>
			</div>
										...
										<div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <ul class="klassique-side-link f-g8">
                                                    ...
                                                    <li><a href="/<?php echo $curr_lang ?>/return-policy" class="active"><i class="fa fa-chevron-right" style="margin-right:5px;"></i><?php echo $language_config[13]['lang_'.$curr_lang] ?></a></li>
											...
											<div class="row inner">
												<div class="col-sm-12">
													<div class="content_element title">
														<h1><?php echo $language_config[13]['lang_'.$curr_lang] ?></h1>
													</div>
