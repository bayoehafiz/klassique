...
$testimonial = global_select("testimonial","*","publish = 1");
?>
	</head>
										...
										<div class="row">
											<div class="col-sm-12">
												...
												<ul class="klassique-side-link f-g8">
													<li><a href="/<?php echo $curr_lang ?>/testimonial" class="active"><i class="fa fa-chevron-right" style="margin-right:5px;"></i>Testimonial</a></li>
														...
														if($testimonial){
															foreach ($testimonial as $key => $value) {?>
																<div class="testi-child">
																	<div class="testi">
																		<p class="testinya"><?php echo $value['testimonial'] ?></p>
																		<span class="testimoner f-g8">&mdash; <?php echo $value['user_name'] ?></span>
																	</div><!-- .testi -->
																</div><!-- .testi-child -->
																<?php
																}
