function updateBorders(color) {
	...
	var warnaSelect_2 = color.toRgbString();
	var warnaSelect = color.toHexString();
	
	$("#color_select").val(warnaSelect);
	$("#color_set").val(warnaSelect);
	$(".wrapper").attr("style","background-color:"+warnaSelect+"; display:none;");
}

function updateBorders2(color) {
    $("#docs-content-2").css("border-color", color.toHexString());
	var warnaSelect_2 = color.toRgbString();
	var warnaSelect = color.toHexString();
	
	$("#color_select_2").val(warnaSelect);
	$("#color_set_2").val(warnaSelect);
	$(".wrapper_2").attr("style","background-color:"+warnaSelect+";");
}

$(function() {

var colorSet = $("#color_set").val();
$("#full").spectrum({
    color: ""+colorSet+"",
    showInput: true,
...
var colorSet_2 = $("#color_set_2").val();
$("#full_2").spectrum({
    color: ""+colorSet_2+"",
    showInput: true,
    className: "full-spectrum",
