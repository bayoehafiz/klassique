	...
	<div id="cms-content" class="clearfix">
		...
		<div class="cms-main-content right">
			...
			<div class="meta-top clearfix">
                <a href="<?php echo $GLOBALS['ADMIN_URL']."export.php?table_name=".$table_name;?>" target="_blank" title="" class="delete-btn left">Export</a><br/><br/>
                ...
                <div class="filter-order">
                      <form action="" method="post" class="meta-form"> 
                       <select onChange="MM_jumpMenu('parent',this,0)" style="width:170px;">
                            ...
                            <option value="ordermember.php?paymentvia=3" <?php if($paymentvia==3): echo'selected="selected"'; endif;?>>BCA</option>
                            <option value="ordermember.php?paymentvia=4" <?php if($paymentvia==4): echo'selected="selected"'; endif;?>>MANDIRI</option>
                        </select>
							...
							if($query->num_rows>0):
								...
								while($row = $query->fetch_assoc()):
										...
										echo'<tr id="wrap-media-'.$row['id'].'">';
											...
											echo'</td>';
											echo'<td><strong style="color:#666; font-size:14px;">IDR '.number_format($totalorder).'</strong>';
											...
											echo'</td>';											
											echo'<td><strong style="text-transform:uppercase; color:#009999;">'.$row['payment_metod'].'</strong><br />by. '.$row['kurir'].'</td>';
											echo'<td>';
