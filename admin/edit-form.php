    ...
    if($excluded_input_field != NULL) { 
      ...
      if(!in_array($fname,$excluded_input_field)) { 
          ...
          <tr>
              ...
              } else if(strpos($fname, "check") !== false) { 
                  
                if(strpos($data[$fname], "M") !== false){
                  $men_check = "checked";
                }else{
                  $men_check = '';
                }

                if(strpos($data[$fname], "F") !== false){
                  $women_check = "checked";
                }else{
                  $women_check = '';
                }
                  ...
                  $output_field .= '<td>
                  <input type="checkbox" name="check_gender[]" value="M" '.$men_check.'> Men<br>
                  <input type="checkbox" name="check_gender[]" value="F" '.$women_check.'> Women<br>
                  </td>';
