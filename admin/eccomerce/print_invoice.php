<?php
	...
	$quemmm = $db->query("SELECT `fullname`,`handphone` FROM `member` WHERE `id`=".$row['idmember']."");
...
<div class="top-wrapper">
	<div class="left-wrapper">
		<div class="text-2">
			...
			<?php echo $namewebsite ?><br /><span style="font-size:11px;">Phone.<?php echo $res['phone'];?></span>
	   </div>
	</div>
...
<div class="title-wrap">
	...
	Name: &nbsp;&nbsp;<strong><?php echo ucwords($datam['fullname']);?></strong><br />
	Phone: &nbsp;<strong><?php echo $datam['handphone'];?></strong>
	</div> 
	<div class="clear-2"></div> 
...
<div class="content-detail">
			...
			?>
					...
					<tr>
						...
						<td colspan="2">
							<strong><?php echo $data['sku'];?></strong> - <?php echo $data['name'];?><br />
							<?php echo $namadetail;?>	
						</td>                    	                        					
			 ...
			 <?php $xpage++; 
			  ...
			  ?>	
			   ...
			   <?php if($row['discountamount']>0):?> 
				...
				<tr>				
					<td colspan="5" align="right" style="padding-top:5px;">Shipping Cost (<strong><?php echo $row['weight'];?> kg</strong>)</td>
