...
?>
	<div class="nuke-wysiwyg" style="width:500px; height:auto; padding:20px;">
     ...
     <?php if($row['id'] > 0):?>
          ...
          <tr>
            <td style="border:1px solid #adadad;padding:5px 10px;text-align:right;background:#f6f6f6">Transfer ke</td>
            <td style="border:1px solid #adadad;padding:5px 10px;text-align:left;border-left:none;background:transparent"><?php echo $row['transferke'];?></td>
          </tr>

          <tr>
            <td style="border:1px solid #adadad;padding:5px 10px;text-align:right;background:#f6f6f6">Foto</td>
            <td style="border:1px solid #adadad;padding:5px 10px;text-align:left;border-left:none;background:transparent"><img src="../uploads_pembayaran/<?php echo $row['foto'];?>"></img></td>
          </tr>
