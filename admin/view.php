                                     ...
                                     while($row = $result->fetch_array()) {
                                        ...
                                        if($excluded_view_field != NULL) { 
                                             ...
                                             if(!in_array($row[0],$excluded_view_field)) { 
                                                ...
                                                array_push($field_type, $row['Type']);
                ...
                while($row = $query->fetch_assoc()):
                    ...
                    if($deletebutton == 1){
                        ...
                        foreach ($field_name AS $key => $val ){
                            ...
                            if(array_key_exists($val, $select_input)) { 
                                ...
                                if($row[$val] != NULL) { 
                                    ...
                                    echo '<a href="'.$upload_folder.$row[$val].'" class="nuke-fancied">
                                            <img src = "'.$upload_folder.$row[$val].'" width="'.($width < 120 ? $width : 120).'" alt = "'.$row[$val].'" />
                                          </a>';
                                } else { echo 'No image'; }
                            ...
                            } else if($field_type[$key] == 'tinyint(1)'){
                                
                                if($row[$val]==1){ 
                                    echo '<td><span class="publish_ok" >Yes</span>
                                          </td>';
                                }else{ 
                                    echo '<td><span class="publish_no" >No</span> 
                                          </td>';
                                }           
                                ...
                                echo '<td>'.substr(strip_tags($row[$val]), 0,200).' ..</td>';
